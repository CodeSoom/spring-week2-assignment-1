...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(NotEnoughException.class)
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public void handleAuthorizationServiceException(NotEnoughException e) {
        logger.warn("NotEnoughException : " , e);
    }
